...
The Cuckoo Filter was implemented in pure JavaScript, with buckets stored in ArrayBuffer to reduce memory-management overhead. 

The test environment consisted of a machine with an Intel Core i7-12700 processor, 16 GB of RAM, NVMe SSD storage, and Ubuntu 22.04 LTS.
